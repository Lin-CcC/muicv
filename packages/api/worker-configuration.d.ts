/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: ee051f3c88250af38a03add02071b2a0)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'RENDER_BASE_URL' | 'OPENAI_API_KEY'>> {}
}
declare module '*.js' {
  const value: string;
