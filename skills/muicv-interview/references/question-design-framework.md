...
|---|---|---|
| 内容质量（事实 / outcome 量化 / STAR）| ✅ 评 | ✅ 评 |

> **量化**仅指 Action 之后产出的 **outcome 指标**（✅ 转化率 +12% / 退货率 8%→3% / P75 800ms→320ms / 排名 #1），不是 scope/编制/件数（❌ "覆盖 3 个站点" / "带 4 人团队" / "维护 30+ 仓库"）。评内容质量时**不要把 scope 数字算成量化**。完整定义见 [docs/quantification-guideline.md](../../../docs/quantification-guideline.md)。
